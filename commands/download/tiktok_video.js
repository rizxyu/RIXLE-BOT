...
conn.send2ButtonImg(m.chat, ttdata.meta.video.cover, teks,userbot.packname,`MP4`, `tnowm ${[args[0]]}`, `MP3` , `tmusic ${[args[0]]}`, {quoted: m, contextInfo: {"mentionedJid": conn.parseMention(teks) }})
} catch (e) {
